...
const NavBar = ({ workspace = false }: NavBarProps) => {
  ...
  if (workspace) {
    return (
      <header className="flex items-center justify-between gap-3 border-b border-[var(--app-border)] bg-[var(--app-chrome)] px-4 py-2 text-[var(--app-text)]">
        <Link href="/problem">
        ...
        <div className="flex items-center justify-between gap-2.5 md:gap-3">
          <div>
            ...
            >
              <SelectTrigger className="h-auto w-full border-none bg-transparent px-0 py-0 text-[12px] font-medium text-[var(--app-muted)] underline-offset-4 shadow-none transition-colors hover:text-[var(--app-text)] hover:underline focus:outline-none! focus:ring-0! md:w-[72px]">
        ...
        <div className="flex items-center gap-2">
          ...
          {!session.data ? (
            <button
              className="app-text-action cursor-pointer text-sm focus:outline-none"
